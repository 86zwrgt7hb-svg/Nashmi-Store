...
const SupermarketStoreContent: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Modals and Overlays - Reusing existing functionality */}
      {showCart && (
        <CartDrawer
          cartItems={cartItems}
          currency={config.currency}
...
export const SupermarketStore: React.FC<SupermarketStoreProps> = (props) => {
  return (
