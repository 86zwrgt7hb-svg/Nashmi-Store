...
const HomeDecorStoreContent: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-amber-50">
            ...
            <div key={category.id} id={`category-${category.id}`} className="mb-16">
              <div className="text-center mb-12">
                ...
                {category.description && (
                  <p className="text-amber-700/70 mt-4 max-w-2xl mx-auto">
                    {category.description}
                  </p>
                )}
              </div>
      ...
      {/* Modals and Overlays - Using existing functionality */}
      {showCart && (
        <CartDrawer
          cartItems={cartItems}
          currency={config.currency}
...
export const HomeDecorStore: React.FC<HomeDecorStoreProps> = (props) => {
  return (
