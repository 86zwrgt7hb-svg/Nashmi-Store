  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden" onClick={onClose}>
      ...
      <div className="absolute inset-0 flex items-center justify-center p-4">
        <div className="bg-white rounded-3xl shadow-2xl w-full max-w-2xl max-h-[95vh] flex flex-col overflow-hidden border-2 border-amber-200" onClick={(e) => e.stopPropagation()}>
          {/* Header */}
          <div className="flex items-center justify-between p-6 border-b border-amber-100 bg-amber-50">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-serif font-bold text-amber-900">{isArabic ? "ملفي الشخصي" : "My Profile"}</h2>
            </div>
          ...
          <div className="flex bg-amber-50 border-b border-amber-200">
            <button
              ...
              className={`flex-1 py-4 px-6 text-sm md:text-base font-semibold transition-all ${
                activeTab === 'profile'
                  ? 'bg-white text-amber-700 shadow-sm border-b-2 border-amber-500'
          ...
          <div className="flex-1 overflow-y-auto p-6 md:p-8 bg-gray-50">
            {activeTab === 'profile' ? (
              ...
              <div>
                <label className="block text-sm font-medium text-amber-800 mb-2">{isArabic ? "الهاتف" : "Phone"}</label>
                <input
                  type="tel"
                  value={profile.phone}
              ...
              <div>
                <label className="block text-sm font-medium text-amber-800 mb-2">{isArabic ? "العنوان" : "Address"}</label>
                <textarea
              ...
              <div>
                <label className="block text-sm font-medium text-amber-800 mb-2">{isArabic ? "الدولة" : "Country"}</label>
                <CountryDropdown
              ...
              <div>
                <label className="block text-sm font-medium text-amber-800 mb-2">{isArabic ? "المدينة" : "City"}</label>
                <CityDropdown
                  stateId={stateId}
                  value={profile.city}
                  onChange={(value, id) => {
              ...
              <div>
                <label className="block text-sm font-medium text-amber-800 mb-2">Postal Code</label>
                <input
                  type="text"
                ...
                <div className="flex gap-3 pt-4">
                  <button
                    type="button"
                    onClick={onClose}
                    className="flex-1 bg-amber-100 hover:bg-amber-200 text-amber-700 font-semibold py-3 px-6 rounded-lg transition-colors"
              ...
              <form onSubmit={handlePasswordSubmit} className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-amber-800 mb-2">Current Password</label>
                  <input
                    type="password"
                    value={passwords.currentPassword}
                    onChange={(e) => handlePasswordChange('currentPassword', e.target.value)}
                    className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500 bg-white ${
                      errors.current_password ? 'border-red-500' : 'border-amber-200'
                    }`}
                ...
                <div>
                  <label className="block text-sm font-medium text-amber-800 mb-2">Confirm New Password</label>
                  <input
                    type="password"
