      ...
      <div className="absolute inset-0 flex items-center justify-center p-0 md:p-4">
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl h-[90vh] flex flex-col overflow-hidden" onClick={(e) => e.stopPropagation()}>
                ...
                <div key={stepNum} className="flex items-center">
                  ...
                  <div className="flex flex-col items-center md:hidden">
                    ...
                    <span className={`mt-1 text-xs ${step >= stepNum ? 'text-blue-600 font-semibold' : 'text-gray-500'}`}>
                      {stepNum === 1 ? (isArabic ? 'معلومات' : 'Info') : stepNum === 2 ? (isArabic ? 'مراجعة' : 'Review') : (isArabic ? 'الدفع' : 'Payment')}
                    </span>
                  </div>

                  {/* Desktop: Horizontal Layout */}
                  <div className="hidden md:flex md:items-center">
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-semibold ${step >= stepNum ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-600'
                      }`}>
                      {stepNum}
                    </div>
                    <span className={`ml-2 text-sm ${step >= stepNum ? 'text-blue-600 font-semibold' : 'text-gray-500'}`}>
                      {stepNum === 1 ? (isArabic ? 'المعلومات' : 'Information') : stepNum === 2 ? (isArabic ? 'المراجعة' : 'Review') : (isArabic ? 'الدفع' : 'Payment')}
                    </span>
                  </div>
          ...
          <div className="flex-1 overflow-y-auto">
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-3 bg-gray-100 rounded-lg p-1">
                              <button
                                ...
                                className={`w-7 h-7 flex items-center justify-center rounded-md text-white text-sm shadow-sm font-bold leading-none ${item.quantity > 1 ? 'bg-blue-600 hover:bg-blue-700 cursor-pointer' : 'bg-gray-400 cursor-not-allowed'
                                  }`}
                              >
                                −
                              </button>
                ...
                <div className="bg-gray-50 rounded-lg p-4 mb-4">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2">
                    <input
                      ...
                      className={`flex-1 px-3 py-3 border rounded-lg focus:outline-none focus:ring-2 text-base bg-white ${couponError ? 'border-red-500 focus:ring-red-500' : 'border-gray-300 focus:ring-blue-500'
                        }`}
                    />
                    <button
            ...
            {step === 3 && (
              <div className="p-4 md:p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4 md:mb-6">{isArabic ? "طريقة الدفع" : "Payment Method"}</h3>
                ...
                {loadingPayments ? (
                  ...
                  <div className="space-y-3">
                    {paymentMethods.map((method) => (
                      <div key={method.name} className={`border-2 rounded-lg transition-all ${selectedPayment === method.name ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-gray-300'
                        }`}>
                          ...
                          <div className="px-4 pb-4 border-t border-gray-200 mt-2 pt-4">
                            ...
                            <div>
                              ...
                              <input
                                ...
                                className={`w-full px-4 py-3 border-2 rounded-lg focus:outline-none bg-white ${whatsappError ? 'border-red-500 focus:border-red-500' : 'border-gray-300 focus:border-green-500'
                                  }`}
                              />
                              {whatsappError && (
