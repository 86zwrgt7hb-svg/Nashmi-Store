      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-2">
          ...
          <PaymentInputField
            ...
            onChange={(value) => handleSettingChange('awsAccessKeyId', value)}
        ...
        <div className="space-y-2">
          ...
          <PaymentInputField
            ...
            onChange={(value) => handleSettingChange('awsSecretAccessKey', value)}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-2">
          ...
          <PaymentInputField
            ...
            onChange={(value) => handleSettingChange('wasabiAccessKey', value)}
            placeholder="AKIAIOSFODNN7EXAMPLE"
          />
        </div>
        ...
        <div className="space-y-2">
          ...
          <PaymentInputField
            ...
            onChange={(value) => handleSettingChange('wasabiSecretKey', value)}
            placeholder="wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY"
            isSecret
          />
        </div>
