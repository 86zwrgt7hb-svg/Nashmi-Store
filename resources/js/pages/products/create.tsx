                ...
                <div>
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <AiGenerateButton
                      ...
                      onGenerated={(content) => handleSelectChange('description', content)}
                    />
                  </div>
                  <RichTextEditor
                ...
                <div>
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <AiGenerateButton
                      ...
                      language="en"
                      categoryName={getSelectedCategoryName()}
                      onGenerated={(content) => handleSelectChange('specifications', content)}
                    />
                  </div>
                  <RichTextEditor
                ...
                <div>
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <AiGenerateButton
                      ...
                      language="ar"
                      categoryName={getSelectedCategoryName()}
                      onGenerated={(content) => handleSelectChange('description_ar', content)}
                    />
                  </div>
                  <RichTextEditor
                ...
                <div>
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <AiGenerateButton
                      ...
                      language="ar"
                      categoryName={getSelectedCategoryName()}
                      onGenerated={(content) => handleSelectChange('specifications_ar', content)}
                    />
                  </div>
                  <RichTextEditor
